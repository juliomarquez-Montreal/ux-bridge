      ...
      <header className="sticky top-0 z-30 border-b border-luminous-outline-variant/70 bg-luminous-surface/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1440px] flex-wrap items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className="flex shrink-0 items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold uppercase tracking-[.05em] hover:bg-white/10"
          >
          ...
          <div className="relative sm:ml-2 sm:flex-1 sm:max-w-md">
            <button
              ...
              onClick={openSearch}
              aria-label="Buscar"
              className="grid h-10 w-10 place-items-center rounded-full border border-white/10 bg-white/5 hover:bg-white/10 sm:hidden"
            >
              <SearchIcon className="h-5 w-5" />
            </button>

            <div className="hidden items-center gap-2 rounded-full border border-white/10 bg-luminous-surface-container/70 px-4 py-2 text-sm sm:flex">
              ...
              />
              <kbd className="hidden shrink-0 rounded-md border border-white/10 bg-white/5 px-1.5 py-0.5 font-mono text-[10px] text-luminous-on-surface-variant lg:block">
                {isMac ? "⌘K" : "Ctrl K"}
              </kbd>
            </div>
